...
const NewsLetter = () => {
  return (
    <section className="flex flex-col items-center text-violet-700 mb-15">
            <div className="flex flex-col items-center">
                <h2 className="text-center text-4xl font-semibold max-w-2xl">Subscribe <span className="text-white bg-gradient-to-t from-indigo-600 to-gray-300 p-1 bg-left inline-block bg-no-repeat">newsletter</span></h2>
