...
export default function PopularPosts() {
  return (
    <div className="w-full bg-transparent px-21 flex flex-row items-center justify-center gap-1">
      <div className="w-fit py-16 md:pl-24 md:w-full mx-2 md:mx-auto flex flex-col items-start justify-center text-left rounded-2xl text-white">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Used by 12k+ developers</p>
          </div>
        </div>
        <h1 className="text-4xl md:text-[46px] md:leading-[60px] font-semibold mt-5 bg-gradient-to-r from-violet-600 to-gray-400 text-transparent bg-clip-text">
          Ready to try-out this app?
        </h1>
        <p className="bg-gradient-to-r from-violet-700 to-gray-700 text-transparent bg-clip-text text-lg">
          Your next favourite tool is just one click away.
        </p>

        <div class="space-y-6 px-4 md:px-0 mt-8">
        ...
        <div className="px-25 mt-37 hover:-translate-y-1 transition duration-300 rounded-lg w-full">
            <img className="rounded-md max-h-60 w-full object-cover" src="https://images.unsplash.com/photo-1560264418-c4445382edbc?q=80&w=400" alt="officeImage" />
