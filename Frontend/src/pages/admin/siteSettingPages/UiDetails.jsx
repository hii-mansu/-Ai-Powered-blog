...
<<<<<<< HEAD
      <h1 className="text-3xl font-bold text-violet-600">Homepage UI Settings</h1>
=======
...
<<<<<<< HEAD
            <InputField label="Hero Title / 1" name="heroTitle1" value={form.heroTitle1} onChange={handleChange} />
            <InputField label="Hero Title / 2" name="heroTitle2" value={form.heroTitle2} onChange={handleChange} />
            <InputField label="Hero Title / 3" name="heroTitle3" value={form.heroTitle3} onChange={handleChange} />
            <InputField label="Categories (comma separated)" name="categories" value={form.categories} onChange={handleChange} />
=======
            <InputField
              label="Hero Title / 1"
              name="heroTitle1"
...
>>>>>>> main
        ...
        <section className="bg-white p-6 rounded-2xl shadow border border-violet-300 space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
<<<<<<< HEAD
            <InputField label="Banner Title" name="midTitle" value={form.midTitle} onChange={handleChange} />
            <InputField label="Banner Subtitle" name="midSubtitle" value={form.midSubtitle} onChange={handleChange} />
=======
            <InputField
              label="Banner Title"
              name="midTitle"
...
<<<<<<< HEAD
              <InputField label={`Point ${i} Title`} name={`point${i}Title`} value={form[`point${i}Title`]} onChange={handleChange} />
              <InputField label={`Point ${i} Subtitle`} name={`point${i}Sub`} value={form[`point${i}Sub`]} onChange={handleChange} />
=======
              <InputField
                label={`Point ${i} Title`}
                name={`point${i}Title`}
...
<<<<<<< HEAD
          <InputField label="Card Title" name="cardTitle" value={form.cardTitle} onChange={handleChange} />
=======
          <InputField
            label="Card Title"
            name="cardTitle"
