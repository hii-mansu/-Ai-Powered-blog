        ...
        <div className='mt-10'>
          <div className="overflow-x-auto bg-white rounded-xl border border-violet-300">
            <div className='bg-violet-50 p-4'>
              <h5 className='flex flex-row gap-2 items-center text-violet-600'><span className='border border-violet-200 text-xs px-2 py-0.5 rounded-lg'>99</span> Drafts found</h5>
            </div>
        ...
        <tbody>
          {allBlogs.filter(blog=>blog.isLive!=true).map((item, index) => (
            ...
            >
              ...
              <td className="p-3">
                <span className='font-normal text-gray-500"'>12/12/2000</span>
              </td>
